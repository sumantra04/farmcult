      ...
      <div className="et-casestudy-container-inner relative w-full h-[550px] md:h-[500px] lg:h-[600px] rounded-[16px] overflow-hidden shadow-none md:shadow-xl group">
        ...
        <div className="absolute inset-0 w-full h-full flex items-center justify-center md:justify-end p-5 lg:pr-16 z-10 pointer-events-none">
          ...
          <Link to={`/case-study/${caseStudy.id}`}>
            ...
            <div className="et-casestudy-inner-card pointer-events-auto bg-[#F7F7F7] md:bg-white/95 backdrop-blur-sm rounded-[16px] p-7 md:p-24 lg:p-12 w-[92%] max-w-[380px] md:max-w-[420px] lg:max-w-[480px] min-h-[440px] md:min-h-[480px] lg:min-h-[520px] shadow-2xl flex flex-col justify-start items-start cursor-pointer">
