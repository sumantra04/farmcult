...
const PiStatsGrid = () => {
  return (
    <div className="pi-stats-grid grid grid-cols-1 md:grid-cols-3 md:divide-x md:border-x border-[#DEDEDE] bg-transparent">
      
      {/* Feature 1 */}
      <div className="pi-stat-item flex flex-col items-center md:items-start text-center md:text-left px-4 md:px-8 lg:px-12 py-6 md:py-4 group flex-1 overflow-hidden">
